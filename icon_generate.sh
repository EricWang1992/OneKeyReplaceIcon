...
# Android target path
androidTargetPath="$HOME/Documents/workspace/youybs-client"
# ios target path
iosTargetPath="$HOME/Documents/workspace/youybs-client/proj.ios_mac/ios/"
# 临时目录
...
androidNameNoTag=(37 huawei jingling kupai linyou muzhiwan oppo vivo wdj xiaomi youku 360)
iosNameWithTag=(91 I4 iPG PP TBT XY )
iosNameNoTag=(HM itools KuaiYong)
